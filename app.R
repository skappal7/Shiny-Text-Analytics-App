...
ui <- fluidPage(
    ...
    titlePanel("Text Analytics App"),
    tags$div(class="header", checked=NA,
             tags$p("Upload any text file and choose a key word to perform an exploratory sentiment analysis")),
    hr(),
    ...
    sidebarLayout(
        ...
        sidebarPanel(
            ...
            hr(),
            tags$div(class="header", checked=NA,
                     tags$p("Sample datasets for exploration."),
            ...
            tags$div(class="header", checked=NA,
                     ...
                     tags$a(href="https://storybench.shinyapps.io/csvanalysis/")),
            hr(),
            tags$div(class="header", checked=NA,
                     tags$p("This analysis uses the R package 'tidytext' and the 'labMT' sentiment dictionary from Andy Reagan. Inspired by Aleszu Bajak."))
